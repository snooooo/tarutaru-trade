      ...
      <article className="mx-auto grid max-w-2xl gap-6 text-stone-800">
        ...
        <section className="grid gap-3">
          ...
          <ol className="grid list-decimal gap-2 pl-5 leading-7">
            <li>
              本サービスは、ウイスキーボトルのトレード相手を探すためのマッチング・告知機能を提供するものです。
            </li>
            <li>
        ...
        <section className="grid gap-3">
          ...
          <ol className="grid list-decimal gap-2 pl-5 leading-7">
            <li>
              利用者は、自身が投稿したトレード投稿、ボトル情報、画像、補足条件等の内容について一切の責任を負います。
            </li>
            <li>
        ...
        <section className="grid gap-3">
          ...
          <ol className="grid list-decimal gap-2 pl-5 leading-7">
            <li>
              X IDは、トレード投稿に対する興味ありを受け取った投稿者が「相談開始」を選択した時点で、相談相手にのみ開示されます。
            </li>
            <li>
        ...
        <section className="grid gap-3">
          ...
          <ol className="grid list-decimal gap-2 pl-5 leading-7">
            ...
            <li>
              利用者はマイページから自身のトレード投稿を非公開化・終了することができます。また、退会機能によりアカウントを削除することができます。
            </li>
          </ol>
        </section>
