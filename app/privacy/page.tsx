      ...
      <article className="mx-auto grid max-w-2xl gap-6 text-stone-800">
        ...
        <section className="grid gap-3">
          ...
          <ul className="grid list-disc gap-2 pl-5 leading-7">
            ...
            <li>匿名配送の利用可否</li>
            <li>トレード投稿の内容（出るボトル・求むボトル・補足条件・画像等）</li>
        ...
        <section className="grid gap-3">
          ...
          <ul className="grid list-disc gap-2 pl-5 leading-7">
            ...
            <li>トレード投稿の表示、検索結果の提供、マッチングの仲介</li>
        ...
        <section className="grid gap-3">
          ...
          <ul className="grid list-disc gap-2 pl-5 leading-7">
            ...
            <li>公開中のトレード投稿の内容（ボトル名・状態・画像・補足条件等）</li>
          </ul>
          <p className="leading-7">
            X IDは公開ページには表示されず、トレード投稿に対する興味ありに対し投稿者が「相談開始」を選択した時点で、相談の当事者間でのみ相互に開示されます。
          </p>
          <p className="leading-7">
        ...
        <section className="grid gap-3">
          ...
          <ul className="grid list-disc gap-2 pl-5 leading-7">
            ...
            <li>
              公開中のトレード投稿は非公開となり、以降は他の利用者に表示されません。
            </li>
            <li>
        ...
        <section className="grid gap-3">
          ...
          <ul className="grid list-disc gap-2 pl-5 leading-7">
            ...
            <li>
              ...
              マイページの自身のトレード投稿一覧から、公開中の投稿を非公開または終了に変更できます。
            </li>
            <li>
